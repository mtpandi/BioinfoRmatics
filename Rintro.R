...
setwd("C:/Users/user/Desktop/PhD/Rintro")
...
vecmean <- function(inpvect){
  s <- sum(inpvect)
  res <- s/length(inpvect)
  return(res)
}
...
source('C:/Users/user/Desktop/PhD/Rintro/vecmean.R')
# Data Types -----------------------------------------------
...
charvec <- c(3 , 5, 'Cat' , NA) #the numbers are converted to characters
